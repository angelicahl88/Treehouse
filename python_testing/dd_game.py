# python3 -m doctest dd_game.py - runs tests from cmd

'''Dungeon Game - explore a dungeon to find a hidden door and escape. Be careful, the grue is hiding behind one door..
...
def get_moves(player):
    '''Based on the tuple of the players position, return the list of acceptable moves

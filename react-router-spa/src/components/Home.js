...
class Home extends Component {
  ...
  handleSubmit(event) {
    ...
    browserHistory.push(path); //redirect user to new url
  }
  ...
  render() {
    return (
      <div className="main-content home">
        ...
        {/* <Link to="featured/Babel/BD Chops">BD Chops</Link>
        <Link to="featured/Angular/Toastface Chickenbum">Toastface Chickenbum</Link> */}
